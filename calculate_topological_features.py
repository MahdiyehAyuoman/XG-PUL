...
NETWORK_FILE = PATH_TO_DATASETS + "PPI.txt"

# --- OUTPUT ---
# Output topological feature matrix
OUTPUT_FILE = PATH_TO_DATASETS + "topological_features.csv"
...
def calculate_and_save_features():
    ...
    start_time = time.time()
    print("7. Calculating Clustering Coefficient...")
    clustering_coefficient = nx.clustering(G)
    print(f"   Done. ({time.time() - start_time:.2f}s)")

    # 4. Combine features into a DataFrame
    print("\n8. Combining all features into a single DataFrame...")
    ...
    # 5. Save to CSV
    print(f"9. Saving features to: {os.path.basename(OUTPUT_FILE)}...")
